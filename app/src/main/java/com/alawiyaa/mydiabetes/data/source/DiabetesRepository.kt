...
class DiabetesRepository private constructor(private val remoteDataSource: RemoteDataSource,
    ...
    companion object {
        @Volatile
        private var instance: DiabetesRepository? = null

        fun getInstance(remoteDataSource: RemoteDataSource, localDataSource: LocalDataSource): DiabetesRepository =
            instance ?: synchronized(this) {
                instance ?: DiabetesRepository(remoteDataSource,localDataSource)
            }
    }
