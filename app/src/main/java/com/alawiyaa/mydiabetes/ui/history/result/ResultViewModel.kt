...
class ResultViewModel(private val mDiabetesRepository: DiabetesRepository) : ViewModel(){
    ...
    fun resultClassification(age:String, gender: String, polyuria:String, polydipsia:String,swl:String,weakness:String,polyphagia:String, gt:String,vb:String,itching:String,irritabiity:String,dh:String,pp:String,ms:String,alopecia:String,obesity:String) : LiveData<ApiResponse<ResponseClassification>> = mDiabetesRepository.resultDiagnosis(age,gender,polyuria,polydipsia,swl,weakness,polyphagia,gt,vb,itching,irritabiity,dh,pp,ms,alopecia,obesity)
